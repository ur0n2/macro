...
server_check_sub:
	...
	server_reconn_check_result1 := server_reconn_check("윤아")
	server_reconn_check_result2 := server_reconn_check("손나은")
...
init_start(id1, id2){ 
	...
	send, #m
	start1 := start_winbaram(id1, "메롱12")
	msgbox, , ,%start1%, 2
	sleep, 5000
	WinWait, %id1%, , 60
	start2 := start_winbaram(id2, "메롱12")
	WinWait, %id2%, , 60
